...
static DEVICE_ATTR(double_tap_enable, S_IRUGO|S_IWUGO, synaptics_attr_doubletap_enable_show, synaptics_attr_doubletap_enable_store);
#endif
...
detect_device:
	...
	print_ts(TS_INFO, "vendor: %d version: %02x%02x\n",
...
/*OPPO 2013-09-28 hewei Add begin */
...
static int __devinit synaptics_ts_init(void)
{
	...
	if (get_pcb_version() < PCB_VERSION_EVT)
		return -EINVAL;
	print_ts(TS_INFO, KERN_INFO "synaptics s3202 init.\n");
